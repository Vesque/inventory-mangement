      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          ...
          <ul class="nav nav-sidebar">
            ...
            <li class="active"><a href="setDiscountPrices.html">Set Discount Prices<span class="sr-only">(current)</span></a></li>
          </ul>
          <ul class="nav nav-sidebar">
...
if($_SESSION["role"]=='staff' OR $_SESSION["role"]=='store_manager'){
  ...
  echo "<a href=\"javascript:history.go(-1)\">Return to Previous Page</a>";
		...
		$sql = "UPDATE inventory_items SET discount_price = $price WHERE SKU = $SKU";
