      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          ...
          <ul class="nav nav-sidebar">
            ...
            <li class="active"><a href="viewSuppliers.php">View Suppliers<span class="sr-only">(current)</span></a></li>
...
if($_SESSION["role"]=='staff'){
  ...
  echo "<a href=\"javascript:history.go(-1)\">Return to Previous Page</a>";
	...
	echo 'Supplier Name: ' . $row['supplier_name'] . ' - Email: ' . $row['supplier_email'] . ' - Phone Number: ' . $row['supplier_phone'] . "<br>";
	}
	} else {
	echo "0 results <br>";
	}
