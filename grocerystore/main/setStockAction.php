    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          ...
          <ul class="nav nav-sidebar">
            <li class="active"><a href="setStock.html">Set Stock Quantity<span class="sr-only">(current)</span></a></li>
...
if($_SESSION["role"]=='regional_manager'){
  ...
  echo "<a href=\"javascript:history.go(-1)\">Return to Previous Page</a>";
	...
	$sql = "UPDATE item_stock_level SET stock_quantity = $stock_quantity WHERE SKU = $SKU and store_id = $store_id" ;
	if ($conn->query($sql) === TRUE) {
		...
		echo "<br/>";
		echo "Error accessing database. <br>" ;
		echo "<a href=\"javascript:history.go(-1)\">Return to Previous Page</a>";
	}
}
$conn->close();
