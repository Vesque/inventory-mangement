      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
		  ...
		  <ul class="nav nav-sidebar">
            ...
            <li class="active"><a href="editStores.html">Edit Store Info<span class="sr-only">(current)</span></a></li>
          </ul>
        </div>
...
if($_SESSION["role"]=='staff' OR $_SESSION["role"]=='store_manager'){
  ...
  echo "<a href=\"javascript:history.go(-1)\">Return to Previous Page</a>";
		...
		$sql = "UPDATE stores SET manager_staff_id = $manager_staff_id where store_id = $store_id";
